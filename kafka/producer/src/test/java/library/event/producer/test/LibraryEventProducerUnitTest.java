...
public class LibraryEventProducerUnitTest {
    ...
    @InjectMocks
    LibraryEventProd eventProducer;
    ...
    void sendLibraryEvent_Approach2_failure() throws JsonProcessingException, ExecutionException, InterruptedException {
        ...
        assertThrows(Exception.class, ()->eventProducer.sendEventsWithProducerRecord(libraryEvent));
    ...
    void sendLibraryEvent_Approach2_success() throws JsonProcessingException, ExecutionException, InterruptedException {
        ...
        ProducerRecord producerRecord = new ProducerRecord("library-events", libraryEvent.getLibraryEventId(),record );
        ...
        ListenableFuture<SendResult<Integer,String>> listenableFuture =  eventProducer.sendEventsWithProducerRecord1(libraryEvent);
